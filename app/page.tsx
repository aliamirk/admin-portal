            ...
            {isPending && (
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 sm:flex-none px-5 py-2.5 rounded-lg bg-gradient-to-r from-emerald-600 to-green-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200"
                >
                  ✓ Approve
                </button>
                <button
                  onClick={() => onReject(pass)}
                  className="flex-1 sm:flex-none px-5 py-2.5 rounded-lg bg-gradient-to-r from-red-600 to-pink-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200"
                >
                  ✗ Reject
                </button>
              </div>
